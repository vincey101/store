...
export default function Product({ params }) {
    ...
    const getProduct = async () => {
        ...
        const respsonse = await fetch(`/api/product/${params.id}`)
        const prod = await respsonse.json()
        ...
        <div>
            <MainLayout>
                ...
                <div className="flex px-4 py-10">
                    ...
                    {/* src={product?.url + '/200' this expression is so bcs the image cdn is too big so i resized by divided it */}
                                ...
                                <div className="flex items-center">
                                    ...
                                    {product?.price
                                        ? <div className="font-bold text-[20px] ml-2">
                                            NGN #{(product?.price / 100).toFixed(2)}
                                        </div>
                                        : null}
                                </div>
